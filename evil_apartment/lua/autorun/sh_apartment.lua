if game.GetMap() == "gm_apartment" then
	...
	for _, v in pairs(file.FindInLua("autorun/vgui/*.lua")) do IncludeClientFile("vgui/" .. v) end
	...
	IncludeClientFile("inventory/sh_init.lua")
	IncludeClientFile("stories/sh_init.lua")
