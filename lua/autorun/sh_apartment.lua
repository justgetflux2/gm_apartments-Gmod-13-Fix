...
function metaPlayer:PlayerBindPress(ply, bind, pressed)
	if !pressed && game.GetMap() == "gm_apartment" then return false end
...
hook.Add("KeyPress","PlayerBindPress",PlayerBindPress)
