...
surface.CreateFont( "evilDescription", {
font  = "Default",
 size  = ScreenScale( 10 ),
	weight  = 0,
	blursize  = 0,
...
surface.CreateFont( "evilItemName", {
font  = "Default",
size  = ScreenScale( 20 ),
weight  = 0,
blursize  = 0,
...
function PANEL:Paint()
	...
	if EVIL_CHEAT_CONVAR:GetBool() then
		...
		draw.DrawText(string.format(debugStr, "CamPos", camPos.x, camPos.y, camPos.z), "Default", x, 25, white, TEXT_ALIGN_RIGHT)
		draw.DrawText(string.format(debugStr, "LookPos", lookPos.x, lookPos.y, lookPos.z), "Default", x, 40, white, TEXT_ALIGN_RIGHT)
		draw.DrawText("FOV: " .. self.Icon:GetFOV(), "Default", x, 55, white, TEXT_ALIGN_RIGHT)
